# existing-mono-inrepo-noport-noingress-autodeploy-20250728000745
...
```
docker build -t existing-mono-inrepo-noport-noingress-autodeploy-20250728000745:latest .
docker run -p:5030:8080 existing-mono-inrepo-noport-noingress-autodeploy-20250728000745:latest
```
